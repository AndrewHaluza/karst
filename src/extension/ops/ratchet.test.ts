...
// value is the measured line count (8384) plus 3 lines of deliberate slack.
// The `makeSimplePanelHost` extraction collapsed the duplicate usage/resources
// panel factories; Task 5's diffs-tree extraction moved the view wiring into
// `src/extension/diffsHost.ts`. Anything larger than a thin binding belongs in
// `src/extension/ops/`.
const MAX_EXTENSION_LINES = 8387;
