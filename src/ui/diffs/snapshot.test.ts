      ...
      worktrees: [
        {
          ...
          commits: [{
            ...
            author: 'Ada',
            authoredAt: '2026-07-30T10:00:00Z',
            files: [{ changeId: 'generation-a:1', status: 'modified', path: 'src/api.ts', oldPath: null, absolutePath: '/worktrees/api/src/api.ts' }],
          }],
          staged: [{ changeId: 'generation-a:2', status: 'modified', path: 'src/staged.ts', oldPath: null, absolutePath: '/worktrees/api/src/staged.ts' }],
          unstaged: [{ changeId: 'generation-a:3', status: 'modified', path: 'src/unstaged.ts', oldPath: null, absolutePath: '/worktrees/api/src/unstaged.ts' }],
          untracked: [],
          error: null,
        },
        {
          ...
          staged: [],
          unstaged: [],
          untracked: [{ changeId: 'generation-a:4', status: 'added', path: 'src/new.ts', oldPath: null, absolutePath: '/worktrees/web/src/new.ts' }],
          error: null,
        },
      ],
    });
